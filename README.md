## MKDS ARM9 Music Slots Table Editor

### Description
The MKDS ARM9 Music Slots Table Editor is a web tool designed to allow users to edit music slot values within Mario Kart DS' `arm9.bin`. With this tool, you can utilize any SSEQ on most slots of the game, enhancing your Mario Kart DS experience.
